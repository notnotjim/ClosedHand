...
const CONFIRMATION_RE = /\b(booking|reservation|confirm|itinerar|e-?ticket|boarding|check-?in|your (stay|order|trip|journey|flight|seats|table)|flight.{0,40}(delay\w*|chang\w*|reschedul\w*)|schedule (change|notification))\b/i;
const MAX_NEW = 60;
