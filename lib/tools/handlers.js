...
`;
    ...
    case "search_documents": {
      ...
      if (results.length === 0) return { results: [], message: "Nothing in the indexed library matches that. drive_search reaches live Google Drive if the file was never indexed." };
      return {
        results,
