...
const INTERNAL_TOOLS = [
  ...
  {
    name: "matter_get",
    description: "The full live record of a matter in flight (people and what each said, facts, what is open, decisions). The compact version is in your instructions under MATTERS IN FLIGHT; use this when you are about to act on one and need every detail, e.g. before writing an update to everyone involved.",
    input_schema: {
      type: "object",
  ...
  {
    name: "matter_resolve",
    description: "Mark a matter in flight as concluded so it stops being carried forward, when the user says it is done or it plainly is.",
    input_schema: {
      type: "object",
      properties: { matter: { type: "string", description: "The matter's short id from the list, or its title" } },
      required: ["matter"],
