...
async function _load() {
  ...
  try {
    ...
    // A failed read, as happens for a moment after the machine wakes, must
    // not be remembered as "no settings" for the whole cache window: keep
    // what was known and try again on the next call.
    return _cache || {};
  }
  _cacheAt = now;
  return _cache;
