    ...
    return {
      messages: {
        create: async (params, options = {}) => {
          ...
          const body = { model: opts.allowedModels?.includes(params.model) ? params.model : fixedModel, messages, max_tokens: params.max_tokens || 4096 };
          ...
          const resp = await fetch(`${baseUrl}/chat/completions`, {
            method: "POST", signal: options.signal, headers, body: JSON.stringify(body),
          });
