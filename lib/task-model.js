...
async function modelCall(client, params, options = {}) {
  ...
  try {
    ...
    // Died as the machine woke: one more try, outside the abort race above.
    try { return response = await require("./sleep-watch").retryAfterWake(error, () => client.messages.create(params)); }
