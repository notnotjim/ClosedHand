const SAFE_READS = new Set(["read_cached_record", "web_search", "web_fetch", "weather_lookup", "search_cache", "search_calendar", "list_flights", "list_bookings", "gcal_list_events", "gcal_search_events", "gcal_list_calendars", "drive_search", "onedrive_search", "maps_search_places", "maps_directions", "maps_geocode", "air_quality"]);
