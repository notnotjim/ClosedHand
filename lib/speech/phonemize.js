...
// See NOTICE and LICENSE. Uses the bundled phonemizer without network access.
let phonemizer;
async function espeakng(text, language) {
  phonemizer ||= import("phonemizer");
  return (await phonemizer).phonemize(text, language);
}
