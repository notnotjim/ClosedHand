...
async function createTask(userId, goal, model, platform, chatId, title = null, successCriteria = null, runtime = {}) {
...
async function updateTask(taskId, updates) {
  ...
  return require("./task-lease").update(supabase, "agent_tasks", taskId, updates);
}
